$(function(){
  ...
  $(document).on('turbolinks:load', ()=> {
    ...
    $('.exhibition__detail__3__2__1').on('click', '.exhibition__detail__3__2__2', function() {
      const targetIndex = $(this).parent().data('index');
      ...
      if ($('.exhibition__detail__3__3__1').length == 0) $('.exhibition__detail__3__2__1').append(buildFileField(fileIndex[0]));
    });
  });
});
